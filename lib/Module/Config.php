	...
	function __invoke($a)
	{
		...
		$a->group('/company', function() {
			...
			$this->get('', function($REQ, $RES, $ARG) {
				return _from_rce_file('company/search.php', $RES, $ARG);
			});
		...
		$a->get('/license-type', function($REQ, $RES, $ARG) {
			return _from_rce_file('license-type.php', $RES, $ARG);
		});
		...
		$a->group('/license', function() {
			...
			$this->get('', function($REQ, $RES, $ARG) {
				return _from_rce_file('license/search.php', $RES, $ARG);
			});

			$this->get('/{guid}', function($REQ, $RES, $ARG) {
				return _from_rce_file('license/single.php', $RES, $ARG);
			});
		...
		$a->get('/contact', function($REQ, $RES, $ARG) {
			return _from_rce_file('contact/search.php', $RES, $ARG);
		});
		...
		$a->get('/product', function($REQ, $RES, $ARG) {
			return _from_rce_file('product/search.php', $RES, $ARG);
		})
		...
		$a->get('/product-type', function($REQ, $RES, $ARG) {
			return _from_rce_file('product-type.php', $RES, $ARG);
		});


		// Create
		//$a->post('/product', function($REQ, $RES, $ARG) {
		//	return _from_rce_file('product/create.php', $RES, $ARG);
		//});

		// Single
		$a->get('/product/{guid}', function($REQ, $RES, $ARG) {
			return _from_rce_file('product/single.php', $RES, $ARG);
		});

		// Modify
		//$this->post('/product/{guid}', function($REQ, $RES, $ARG) {
		//	return _from_rce_file('product/update.php', $RES, $ARG);
		//});

		// Delete
		$a->delete('/product/{guid}', function($REQ, $RES, $ARG) {
			return _from_rce_file('product/delete.php', $RES, $ARG);
		});
		...
		*/
		...
		$a->get('/zone', function($REQ, $RES, $ARG) {
			return _from_rce_file('zone/search.php', $RES, $ARG);
		});

		$a->get('/zone/{guid}', function($REQ, $RES, $ARG) {
			return _from_rce_file('zone/select.php', $RES, $ARG);
		});

		$a->post('/zone', function($REQ, $RES, $ARG) {
			return _from_rce_file('zone/create.php', $RES, $ARG);
		});

		$a->post('/zone/{guid}', function($REQ, $RES, $ARG) {
			return _from_rce_file('zone/update.php', $RES, $ARG);
		});

		$a->delete('/zone/{guid}', function($REQ, $RES, $ARG) {
			return _from_rce_file('zone/delete.php', $RES, $ARG);
		});
